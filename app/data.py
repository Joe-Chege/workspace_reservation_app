...
def import_dummy_data():
    # create users
    new_user = User(email="joe@gmail.com", firstname="Joe", lastname="chege",
                    password=generate_password_hash("1"))

    new_user1 = User(email="h@gmail.com", firstname="Gesh", lastname="ngee",
                     password=generate_password_hash("beets"))

    new_user2 = User(email="njorochegeh@gmail.com", firstname="joseph", lastname="njoroge", role="admin",
